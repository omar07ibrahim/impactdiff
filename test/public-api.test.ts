...
import type {
  ...
  PilotFixtureWorkflowCaptureAuthoringResult,
  PilotFixtureWorkflowPredicateAuthoringResult,
  PilotGenerationPlan,
...
function acceptsPublicTypes(
  ...
  _pilotFixtureAuthoringCheckpoint: PilotFixtureAuthoringCheckpointBytes,
  _pilotFixtureAuthoringCheckpointTuple: PilotFixtureAuthoringCheckpointTuple,
  ...
  _pilotFixturePointerBaselineRun: PilotFixturePointerHitTestingBaselineAuthoringRun,
  _pilotFixturePointerCandidateRun: PilotFixturePointerHitTestingCandidateAuthoringRun,
  _pilotFixturePointerCandidateOutcome: PilotFixturePointerHitTestingCandidateTaskOutcome,
  _pilotFixturePointerDefinitionKey: PilotFixturePointerHitTestingDefinitionKey,
  _pilotFixturePointerPairResult: PilotFixturePointerHitTestingPairAuthoringResult,
  _pilotFixtureWorkflowAuthoringAudit: PilotFixtureWorkflowAuthoringAudit,
  _pilotFixtureWorkflowCaptureResult: PilotFixtureWorkflowCaptureAuthoringResult,
  _pilotFixtureWorkflowPredicateResult: PilotFixtureWorkflowPredicateAuthoringResult,
  _pilotGenerationPlan: PilotGenerationPlan,
  _pilotMutationPredicateObservation: PilotMutationPredicateObservation,
  _pilotMutationPredicateObservationTuple: PilotMutationPredicateObservationTuple,
...
test("the package root exposes the capture, storage, mutation, and resolver API", () => {
  const expectedFunctions = [
    ...
    "measurePilotFixtureAuthoringWorkflowPredicates",

...
future publisher must materialize that artifact only in the sealed store while keeping
the model-visible capture specification limited to renderer/environment provenance and
